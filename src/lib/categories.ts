...
export const CATEGORIES: CategoryConfig[] = [
  {
    ...
    attributes: [
      ...
      { key: "tractiune", label: "Tractiune", type: "select", options: ["Fata", "Spate", "4x4 / AWD", "Altele"] },
      { key: "tara_inmatriculare", label: "Tara inmatriculare", type: "text", placeholder: "ex: Romania, Germania" },
      { key: "istoric_service", label: "Istoric service", type: "select", options: ["Complet", "Partial", "Nu exista", "Nu stiu"] },
